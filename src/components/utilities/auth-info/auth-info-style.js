...
const InfoWraper = Styled.div`
    ...
    .dm-nav-actions__support, 
    .dm-nav-actions__flag-select,
    .dm-nav-actions__language,
    .dm-nav-actions__searchbar,
    .dm-nav-actions__nav-author{
        display: flex;
        margin: 0 5px;
        span, a{
            display: block;
...
const UserActionDropDown = Styled.div`
    .dm-top-dropdown__title .title-text {        
        ${({ theme }) => (!theme.rtl ? 'margin-right' : 'margin-left')}: 10px;
    }
    .dm-top-dropdown__content {
        figcaption{
            .dm-top-dropdownText{
                min-width: 216px;
...
export { InfoWraper, SettingDropdwon, UserDropDwon, UserActionDropDown, NavAuth };
