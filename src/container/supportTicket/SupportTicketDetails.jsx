        ...
        {dataState.length ? (
          <TicketDetailsBox>
            <Row gutter={15}>
              ...
              <Col lg={16} xs={24}>
                <div className="dm-ticket-details">
                  <Cards headless title={dataState[0].subject}>
                    <Row>
                      <Col md={8} xs={24}>
                        <div className="dm-ticket-author">
                          <h4 className="dm-ticket-details__top-title">Requested By:</h4>
                          <div className="dm-ticket-author__info">
                            <img style={{ width: '30px' }} src={require(`../../${dataState[0].user.img}`)} alt="" />
                            <span className="dm-ticket-author__name">{dataState[0].user.name}</span>
                          </div>
                          <h4>Priority</h4>
                          <Select
                      ...
                      <Col md={8} xs={24}>
                        <div className="dm-ticket-date-info">
                          <div className="dm-ticket-date-info__text">
                            <h4 className="dm-ticket-details__top-title">Created Date</h4>
                      ...
                      <Col md={8} xs={24}>
                        <div className="dm-ticket-date-info">
                          <div className="dm-ticket-date-info__text">
                            <h4 className="dm-ticket-details__top-title">Updated Date</h4>
                            <span>February 02, 2020</span>
                          </div>
                        </div>
                      </Col>
                    </Row>
                    <div className="dm-ticket-overview">
                      <h4 className="dm-ticket-overview__title">Overview :</h4>
                ...
                <ClientConversation>
                  <Cards headless title="Conversation">
                    <List
                      className="dm-client-conversation-list"
                      ...
                      renderItem={(item) => (
                        <List.Item key={item.email}>
                          ...
                          />
                          <span className="dm-conversation-time">{item.time}</span>
                        </List.Item>
                      )}
                    />
              ...
              <Col lg={8} xs={24}>
                <div className="dm-ticket-file-system">
                  <Cards bordered={false} title="File Attachment">
                    <div className="dm-ticket-file-list">
                      <div className="dm-ticket-file-item d-flex">
                        <div className="dm-ticket-file-item__info d-flex">
                          <div className="dm-ticket-file-item__logo">
                            <img
                              style={{ width: '40px' }}
                          ...
                          <div className="dm-file-item__content">
                            <span className="dm-ticket-file-name">Main-admin-design.zip</span>
                            <span className="dm-ticket-file-size">7.05 MB</span>
                          </div>
                        </div>
                        <Link className="dm-ticket-file-item__action" to="#">
                          <UilUpload />
                        </Link>
                      </div>
                      ...
                      <div className="dm-ticket-file-item d-flex">
                        <div className="dm-ticket-file-item__info d-flex">
                          ...
                          <div className="dm-file-item__content">
                            <span className="dm-ticket-file-name">Product-guidelines.pdf</span>
                            <span className="dm-ticket-file-size">522 KB</span>
                          </div>
                        </div>
                        <Link className="dm-ticket-file-item__action" to="#">
                          <UilUpload />
                      ...
                      <div className="dm-ticket-file-item d-flex">
                        <div className="dm-ticket-file-item__info d-flex">
                          ...
                          <div className="dm-ticket-file-item__content">
                            <span className="dm-ticket-file-name">admin-wireframe.psd</span>
                            <span className="dm-ticket-file-size">2.05 MB</span>
                          </div>
                        </div>
                        <Link className="dm-ticket-file-item__action" to="#">
                          <UilImport />
