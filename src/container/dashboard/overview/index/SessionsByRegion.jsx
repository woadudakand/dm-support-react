...
import { RegionTableWrap, SessionRegionMap } from '../../Style';
...
const SessionsByRegion = React.memo(() => {
  ...
  return (
    <Cards title="Sessions by Region" size="large" more={moreContent}>
      <Row>
