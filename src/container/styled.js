...
const Main = Styled.div`
    ...
    .ant-card-head{
        ...
        .dm-card-title-wrap{
            ...
            .dm-card-title-extra-text{
                display: flex;
                align-items: center;
                position: relative;
                top: 3px;
                .dm-total-chart-total{
                    font-size: 18px;
                    font-weight: 600;
                    color: ${({ theme }) => theme[theme.mainContent]['dark-text']};
                    @media only screen and (max-width: 991px){
                ...
                .dm-total-chart-status{
                    ...
                    &.dm-total-chart-status-growth{
                        color: ${({ theme }) => theme['success-color']};
                    }
                    &.dm-total-chart-status-down{
            ...
            .product-single{
                ...
                .product-single__info{
                    ...
                    h6{
                        font-size: 14px;
                        font-weight: 500;
                        color: ${({ theme }) => theme[theme.mainContent]['title-text']};
                    }
                    p{
                        margin-bottom: 0;
                    }
                    ...
                    .info-list {
                        ...
                        li {
                            .info-title {
                                ...
                                font-size: 12px;
                                text-transform: capitalize;
                                color: ${({ theme }) => theme[theme.mainContent]['deep-gray-text']};
                                .cat-title {
                                    margin-right: 5px;
                                    color: ${({ theme }) => theme[theme.mainContent]['title-text']};
                                }
