...
const LayoutContainer = Styled.div`
        ...
        &.show{            
            .dm-searchbar{
                ...
                .ant-input-affix-wrapper {
                    ...
                    border-color: ${({ theme }) => theme[theme.mainContent]['dark-background']};
                }
                input{
                    user-select: all;
                    pointer-events: all;
    ...
    .dm-header-content{
        ...
        .dm-header-content__right{
            ...
            .dm-nav-actions{
                ...
                .dm-nav-actions__language,
                .dm-nav-actions__author{
                    line-height: 1;
                }
                .dm-nav-actions__searchbar{
                    margin-right: 10px;
    ...
    .dm-header-more{
        ...
        .dm-nav-actions__message,
        .dm-nav-actions__notification,
        .dm-nav-actions__settings{
            position: relative;
            top: 4px;
        }
    }
...
export { NavTitle, FooterStyle, LayoutContainer, SmallScreenAuthInfo, TopMenuStyle, TopMenuSearch };
